...
public class SpecialdAdapter extends RecyclerView.Adapter<SpecialdAdapter.MyViewHolder> {

    // 3.创建一个构造方法
    private Context context;
    private List<SpecialBean> mDatas;
    private LayoutInflater mInflater;// 3.1声明LayoutInflater传入Item布局
    // 0.1实现瀑布流，要将MyViewHolder修改为内部类
    // 0.2实现瀑布流效果，设置随机高度
    private List<Integer> mHeights;

    public SpecialdAdapter(Context context, List<SpecialBean> datas) {
    ...
    public void setmDatas(List<SpecialBean> datas) {
        this.mDatas = datas;
    ...
    @Override
    public void onBindViewHolder(SpecialdAdapter.MyViewHolder arg0, int arg1) {
    ...
    @Override
    public SpecialdAdapter.MyViewHolder onCreateViewHolder(ViewGroup arg0,
                                                           int arg1) {
        // 4.y引入Item布局
