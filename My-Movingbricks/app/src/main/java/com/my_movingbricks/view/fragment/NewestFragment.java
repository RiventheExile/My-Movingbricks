...
public class NewestFragment extends BaseMvpFragment<RecommendedView, RecommendedPresenter> implements RecommendedView{
    ...
    protected void onVisible(boolean isInit) {
        if (isInit) {
            // initView();//初始化控件
            presenter.netGetData(U.mBaseTypeUrl(1));
        }
    }
        ...
        mRecyclerView.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onLoadMore() {
                ...
                if (q > Maximum) {
                    ...
                    isRefresh = false;
                    presenter.netGetListData(U.mBaseTypeUrl(1),1,q);
                }
            }
        });
