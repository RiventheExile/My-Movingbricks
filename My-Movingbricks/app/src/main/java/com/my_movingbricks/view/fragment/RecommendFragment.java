 ...
 * @author itlanbao.com
 */
public class RecommendFragment extends BaseMvpFragment<RecommendedView, RecommendedPresenter> implements RecommendedView, AdapterView.OnItemClickListener {
    ...
    protected void onVisible(boolean isInit) {
        if (isInit) {
            // initView();//初始化控件
            presenter.netGetData(U.mBaseTypeUrl(3));
        }
    }
    ...
    protected void initView(View view) {
        ...
        mRecyclerView.setLoadingListener(new XRecyclerView.LoadingListener() {
            ...
            public void onLoadMore() {
                ...
                if (q > Maximum) {
                    ...
                    isRefresh = false;
                    presenter.netGetListData(U.mBaseTypeUrl(3),3,q);
                }
        ...
        mRecyclerView.addOnItemTouchListener(new OnRecyclerItemClickListener(mRecyclerView) {
            ...
            public void onItemClick(RecyclerView.ViewHolder viewHolder) {
                ...
                if(viewHolder.getAdapterPosition()-1>mRatingArray.size())
