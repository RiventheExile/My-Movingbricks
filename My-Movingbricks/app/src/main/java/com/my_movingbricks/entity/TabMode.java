package com.my_movingbricks.entity;
...
public class TabMode {
    ...
    // tab内容Fragment
    private BaseMvpFragment tabContent = null;
    // 是否为默认显示
    ...
    public TabMode(int tabId, int iconResId, String tabText, int textColorResId,  BaseMvpFragment tabContent) {
        this.tabId = tabId;
    ...
    public TabMode(int tabId, int iconResId, String tabText, int textColorResId, BaseMvpFragment tabContent, boolean isDefaultShow) {
        this.tabId = tabId;
        this.iconResId = iconResId;
        this.tabText = tabText;
        this.textColorResId = textColorResId;
    ...
    public TabMode(int tabId, int iconResId, String tabText, int textColorResId, int textSize, BaseMvpFragment tabContent, boolean isDefaultShow) {
        this.tabId = tabId;
        this.iconResId = iconResId;
        this.tabText = tabText;
        this.textColorResId = textColorResId;
    ...
    public TabMode(int tabId, int iconResId, String tabText, int textColorResId, int textSize, int tabSelectorResId, BaseMvpFragment tabContent, boolean isDefaultShow) {
        this.tabId = tabId;
        this.iconResId = iconResId;
        this.tabText = tabText;
        this.textColorResId = textColorResId;
    ...
    public BaseMvpFragment getTabContent() {
        return tabContent;
    }

    public void setTabContent(BaseMvpFragment tabContent) {
        this.tabContent = tabContent;
    }
