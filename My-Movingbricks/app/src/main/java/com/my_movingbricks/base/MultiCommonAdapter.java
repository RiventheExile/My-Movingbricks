...
public abstract class MultiCommonAdapter<T> extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        ViewHolder holder = ViewHolder.get(context, view,
                layout_ids[getLayoutIndex(data.get(position))],parent, position);
     ...
     */
    public abstract void convert(ViewHolder h, T entity, int position, int layoutIndex);
